...
# extracts
default[:metroextractor][:extracts][:osmconvert_timeout] = 172_800
default[:metroextractor][:extracts][:osmconvert_jobs]    = node[:cpu][:total]

# set osmconvert heap (per process!!!)
default[:metroextractor][:extracts][:osmconvert_heap]    = '15G'
default[:metroextractor][:extracts][:osmconvert_jvmopts] = "-server -XX:SurvivorRatio=8 -Xms#{node[:metroextractor][:extracts][:osmconvert_heap]} -Xmx#{node[:metroextractor][:extracts][:osmconvert_heap]}"
